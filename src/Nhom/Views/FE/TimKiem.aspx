<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site1.Master" AutoEventWireup="true" CodeBehind="TimKiem.aspx.cs" Inherits="Nhom.Views.FE.TimKiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">   
        ...
        <asp:DataList ID="datatimchude" runat="server">
            <ItemTemplate>
                 <h2 style="color:orangered;">Chủ đề</h2>
          ...
          <asp:DataList ID="datatimcasi" runat="server">
            <ItemTemplate>
                 <h2 style="color:orangered;">Ca sĩ</h2> 
                <div class="dl">    
        ...
        <asp:DataList ID="datatimtheloai" runat="server">
            <ItemTemplate>
                  <h2 style="color:orangered;">Thể loại</h2>
                        <div>   
        ...
        <asp:DataList ID="datatimplaylist" runat="server">
            <ItemTemplate>
                 <h2 style="color:orangered;">PlayList</h2>
                  <div class="pl" > 
        ...
        <asp:DataList ID="datatimbaihat" runat="server">
            <ItemTemplate>
                  <h2 style="color:orangered;">Bài Hát</h2>
                        <div class="dsbh">
      ...
      <asp:DataList ID="datatimalbum" runat="server">
            <ItemTemplate>
                   <h2 style="color:orangered;">Album</h2>  
                <div class="dsab">
