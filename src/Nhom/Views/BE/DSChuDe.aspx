<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site2.Master" AutoEventWireup="true" CodeBehind="DSChuDe.aspx.cs" Inherits="Nhom.Views.BE.DSChuDe" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="noidung2" runat="server">
    <h4 style="color:orangered;text-align:center;">Danh sách chủ đề</h4>
    <br />
    <asp:GridView runat="server" ID="GridView2" AutoGenerateColumns="false" Width="1200" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
        <Columns>
